...
public final class Render {
    ...
    public static BufferedImage frame(Panel panel, HashMap<String, BufferedImage> imageMap){
        ...
        BufferedImage frame = new BufferedImage(background.getWidth(), background.getHeight(), BufferedImage.TYPE_INT_ARGB);
    ...
    public static BufferedImage resizeBackground(BufferedImage img, int x, int y){
        ...
        // take center of the iamge, croping away transparent borders
